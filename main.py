...
if __name__ == "__main__":
	...
	if do_evaluation:
		...
		mean_reward, median_reward, allRewards = resources.evaluate_agent(
			 best_agent, env_eval, num_episodes=10)
		...
		print("RL agent")
		resources.evaluate_agent(best_agent, env_eval, num_episodes=1, init=[[-0.5, -0.5], 0.785, 1.57])
		
		print("PD controller")
		resources.evaluate_agent(pdController, env_eval_pd, num_episodes=1, init=[[-0.5, -0.5], 0.785, 1.57])
